...
DEFAULT_SETTINGS = {
    # Identidad Central
    "barber_name": "BARBERÍA DIGITAL",
    "app_name": "Barbería Digital",
    "short_name": "Barbería",
    "browser_title": "Barbería Digital // Turnero & Shop",
    "description": "Atelier de autor. Reservá tu turno y descubrí nuestro Shop Barber.",
    "phone": "5493834123456",
    "whatsapp": "5493834123456",
    "email": "contacto@barberia.app",
    "address": "Av. Belgrano 1234",
    "city": "Catamarca",
    "province": "Catamarca",
    "instagram": "@barberia",
    "facebook": "barberia.oficial",
    "tiktok": "@barberia",
    "website": "https://barberia.app",
    "google_maps": "https://maps.google.com",
    
    # Textos Principales
    "welcome_title": "ATELIER DE AUTOR",
    "welcome_sub": "Experiencia premium en degradados milimétricos, barboterapia de navaja y visagismo facial.",
    "text_welcome": "Bienvenido a nuestro Atelier de Barbería de autor.",
    ...
    "text_footer": "BARBERÍA DIGITAL // RESERVAS & SHOP © 2026",
    ...
    # PWA
    "pwa_name": "Barbería Digital",
    "pwa_short_name": "Barbería",
